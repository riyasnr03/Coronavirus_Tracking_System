...
public class CoronaVirusDataServices 
{
	...
	private static String VIRUS_DATA_URL="https://rawcdn.githack.com/CSSEGISandData/COVID-19/master/csse_covid_19_data/csse_covid_19_time_series/time_series_covid19_deaths_global.csv";
	@PostConstruct
	@Scheduled(cron = "* * * 1 * *")
	...
	if (httpResponse.body().startsWith("<!DOCTYPE html>")) {
	    System.err.println("Error: Received HTML response instead of CSV data.");
